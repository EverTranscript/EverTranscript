...
- **Bitrate is deliberately left open**, and wants a listening check against Transcription and Diarization quality rather than a guess. It is the one remaining lever over both disk and fidelity.
